...
namespace Entidades
{
    ...
    public sealed class Taller // agregue modificador sealed
    {
        ...
        public static string Listar(Taller taller, ETipo tipo)
        {
            ...
            sb.AppendFormat("Tenemos {0} lugares ocupados de un total de {1} disponibles", taller.vehiculos.Count, taller.espacioDisponible); // muestro el espacio total disponible sumando el espacio ocupado y el espacio disponible actual
            sb.AppendLine("");
